...
namespace SimulationTask1
{
    public partial class serversChart : Form
    {
        ...
        public void plotChartAble(int [] ableCustomers,int ableCustNum,double [] beginService , double [] endService,int custnum)
        {
            ...
            for (double q = 0; q <= endService[custnum]; q+=0.1)
            {
                idle = true;
        ...
        public void plotChartBaker(int[] bakerCustomers, int bakerCustNum, double[] beginService, double[] endService, int custnum)
        {
